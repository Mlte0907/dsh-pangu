...
@media (max-width:1040px){.pangu-dashboard-two,.pangu-dashboard-lower{grid-template-columns:1fr}.pangu-dashboard-metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.pangu-dashboard-split{grid-template-columns:1fr}.pangu-dashboard-master[data-drawer="open"]{grid-template-columns:minmax(0,1fr) minmax(0,1fr)}.pangu-dashboard-list-col{position:static;max-height:46vh}.pangu-dashboard-admin{grid-template-columns:1fr}.pangu-dashboard-admin-nav{flex-direction:row;overflow-x:auto}}

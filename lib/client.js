...
.pangu-dashboard-topbar{display:grid!important;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:12px;min-height:66px!important;padding:0 18px!important;border-bottom:1px solid ${css.borderSoft}!important;background:${css.bg2}!important;flex-shrink:0!important}
.pangu-dashboard-brand{display:flex;align-items:center;gap:9px;min-width:0;color:${css.t2};font-size:11.5px;font-weight:650;white-space:nowrap}
...
.pangu-dashboard-brand-copy small{overflow:hidden;color:${css.t3};font-size:9.5px;font-weight:400;text-overflow:ellipsis;white-space:nowrap}
.pangu-dashboard-brand-copy strong{overflow:hidden;color:${css.t1};font-size:14px;font-weight:650;line-height:1.2;text-overflow:ellipsis;white-space:nowrap}
...
.pangu-dashboard-tabs{display:flex;align-items:stretch;gap:2px;min-height:40px!important;padding:0 18px;border-bottom:1px solid ${css.borderSoft}!important;background:${css.bg2}!important;flex-shrink:0!important;overflow-x:auto;scrollbar-width:none}
.pangu-dashboard-tabs::-webkit-scrollbar{display:none}
.pangu-dashboard-tab{display:inline-flex;align-items:center;gap:6px;min-height:40px;padding:0 12px;border:0;border-bottom:2px solid transparent;background:transparent;color:${css.t2};font-size:11.5px;white-space:nowrap;cursor:pointer;transition:color .15s,border-color .15s,background .15s}
.pangu-dashboard-tab:hover{color:${css.t1};background:${css.hover}}
.pangu-dashboard-tab[data-active="true"]{border-bottom-color:${ACCENT};color:${ACCENT};font-weight:650}
...
.pangu-dashboard-metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1px;overflow:hidden;border:1px solid ${css.border};border-radius:12px;background:${css.borderSoft}}
.pangu-dashboard-metric{min-width:0;padding:11px 13px;background:${css.bg1}}
.pangu-dashboard-metric[data-primary="true"]{background:linear-gradient(135deg,${ACCENT}24 0%,${ACCENT}0d 46%,${css.bg1} 100%)!important;box-shadow:inset 3px 0 0 ${ACCENT}}
...
.pangu-dashboard-status-row{display:flex;align-items:center;gap:8px;min-height:34px;border-bottom:1px solid ${css.borderSoft};color:${css.t2};font-size:10.5px}
.pangu-dashboard-status-row:last-child{border-bottom:0}
.pangu-dashboard-status-row .status-label{flex:1}
.pangu-dashboard-status-row .status-value{color:${css.t1};font:10.5px ui-monospace,SFMono-Regular,Menlo,monospace}
.pangu-dashboard-status-row .status-state{display:inline-flex;align-items:center;gap:5px;font-size:10px}
...
.pangu-dashboard-lower{display:grid;grid-template-columns:minmax(0,1.1fr) minmax(280px,.9fr);gap:14px}
...
@media (max-width:1040px){.pangu-dashboard-two,.pangu-dashboard-lower,.pangu-dashboard-list-detail{grid-template-columns:1fr}.pangu-dashboard-detail{position:static}.pangu-dashboard-metrics{grid-template-columns:repeat(3,minmax(0,1fr))}.pangu-dashboard-metric[data-primary="true"]{grid-column:span 2}.pangu-dashboard-admin{grid-template-columns:1fr}.pangu-dashboard-admin-nav{flex-direction:row;overflow-x:auto}}
      ...
      return h('div', { className: 'pangu-dashboard-scroll', style: { padding: '22px 26px 42px' } },
        h('section', { className: 'pangu-dashboard-view' },
          ...
          h('div', { className: 'pangu-dashboard-metrics', style: { marginBottom: 14 } },
            h(DashboardMetric, { label: '记忆总量', value: s?.total != null ? fmtNum(s.total) : '—', detail: s?.health ? '健康 ' + s.health : '宫殿结构', primary: true }),
            ...
            h(DashboardMetric, { label: '待验证', value: pipe?.pending_review != null ? fmtNum(pipe.pending_review) : '—', detail: '召回成功后自动毕业' }),
            h(DashboardMetric, { label: '最近巩固', value: consLabel, detail: '窗口 03:00–05:00' }),
          ),
